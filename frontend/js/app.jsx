    ...
    <Router>
      <Routes>
        ...
        <Route path="/" element={<Layout />}>
          ...
          {/* Team Leader Routes */}
          <Route path="dashboard/team-employees" element={<div className="p-5 text-center"><h1>My Team</h1><p>This page is under construction.</p></div>} />
          ...
          <Route path="dashboard/my-leave" element={<div className="p-5 text-center"><h1>My Leave</h1><p>This page is under construction.</p></div>} />
          <Route path="dashboard/my-attendance" element={<div className="p-5 text-center"><h1>My Attendance</h1><p>This page is under construction.</p></div>} />
