    ...
    <div className="payroll-projection-container">
      <div className="card shadow-sm mb-4">
        <div className="card-body p-4">
          <h5 className="card-title">Select Projection Period</h5>
          <p className="card-text text-muted">Select a date range to see your estimated gross income based on your attendance records.</p>
      ...
      {hasValidDateRange && projectionData && (
        <div className="card shadow-sm">
            <div className="card-body p-4">
                ...
                <h6 className="mt-4">Daily Breakdown</h6>
                <div className="table-responsive breakdown-table-container">
                    <table className="table data-table table-sm table-striped mb-0">
                        <thead><tr><th>Date</th><th>Status</th><th className="text-right">Estimated Earning</th></tr></thead>
                        <tbody>
