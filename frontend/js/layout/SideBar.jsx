...
const navItemsConfig = {
  [USER_ROLES.HR_PERSONNEL]: [
    ...
    { path: '/dashboard/payroll', icon: 'bi-cash-coin', label: 'Payroll Management' },
  ...
  [USER_ROLES.TEAM_LEADER]: [
    ...
    { path: '/dashboard/leave-management', icon: 'bi-calendar-event', label: 'Team Leaves' },
  ...
  [USER_ROLES.REGULAR_EMPLOYEE]: [
    ...
    { path: '/dashboard/my-leave', icon: 'bi-calendar-plus-fill', label: 'My Leave' },
    { path: '/dashboard/my-attendance', icon: 'bi-person-check-fill', label: 'My Attendance' },
    { path: '/dashboard/my-payroll', icon: 'bi-wallet2', label: 'My Payroll' },
    { path: '/dashboard/evaluate-self', icon: 'bi-person-video2', label: 'My Evaluations' },
  ],
};
